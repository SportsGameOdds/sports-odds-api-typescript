...
[Open VS Code](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22sports-odds-api-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22sports-odds-api-mcp%22%5D%2C%22env%22%3A%7B%22SPORTS_ODDS_API_KEY_HEADER%22%3A%22My%20API%20Key%20Param%22%7D%7D)
...
```
claude mcp add sports_odds_api_mcp_api --env SPORTS_ODDS_API_KEY_HEADER="My API Key Header" SPORTS_ODDS_API_KEY_HEADER="My API Key Param" -- npx -y sports-odds-api-mcp
```
